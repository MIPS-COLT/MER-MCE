...
from minigpt4.datasets.datasets.first_face import FirstfaceDataset, ECACEmotionDataset
...
@registry.register_builder("first_face_caption")
class FirstfaceCaptionBuilder(BaseDatasetBuilder):
    train_dataset_cls = FirstfaceDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/firstface/caption.yaml"}
...
@registry.register_builder("ECAC_emotion_caption")
class ECACEmotionCaptionBuilder(BaseDatasetBuilder):
    train_dataset_cls = ECACEmotionDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/firstface/ecac_emotion.yaml"}
